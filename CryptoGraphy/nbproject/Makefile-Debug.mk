...
${OBJECTDIR}/lecture1/CeaserCipher.o: lecture1/CeaserCipher.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lecture1/CeaserCipher.o lecture1/CeaserCipher.cpp

${OBJECTDIR}/lecture1/CeaserDecrypthor.o: lecture1/CeaserDecrypthor.cpp
	${MKDIR} -p ${OBJECTDIR}/lecture1
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lecture1/CeaserDecrypthor.o lecture1/CeaserDecrypthor.cpp

${OBJECTDIR}/lecture1/ViginerCipher.o: lecture1/ViginerCipher.cpp
	${MKDIR} -p ${OBJECTDIR}/lecture1
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lecture1/ViginerCipher.o lecture1/ViginerCipher.cpp

${OBJECTDIR}/lecture1/ViginerDecryptor.o: lecture1/ViginerDecryptor.cpp
	${MKDIR} -p ${OBJECTDIR}/lecture1
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lecture1/ViginerDecryptor.o lecture1/ViginerDecryptor.cpp
