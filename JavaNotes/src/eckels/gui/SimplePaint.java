...
public class SimplePaint extends JPanel implements MouseListener, MouseMotionListener{
     ...
     */
    public static void runSimplePaint() {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        //    when user is already drawing a curve.
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        // Adjust the value of x, to make sure it's in the drawing area.
        if(x < 3) { 
            x = 3;  
        }
        if(x > getWidth() - 57) {
        ...
        // Adjust the value of y, to make sure it's in the drawing area.
        if(y < 3) {
            y = 3;
        }
        if(y > getHeight() - 4) {
