...
public class RandomMosaicWalk2 {
     ...
     */
    public static void runMosaicWalk2() {
    ...
    static void changeToGreen(int row, int col) {
        int green = Mosaic.getGreen(row, col);
        if(green < 255) {
            Mosaic.setColor(row, col, 0, green + 25, 0);
        }
    }
    static void fillWithGreens() {
    ...
    public static void runGreenMosaic() {
        Mosaic.open(ROWS, COLUMNS, SQUARE_SIZE, SQUARE_SIZE);
    ...
    static void randomMove2(int row, int col) {
        ...
        Mosaic.setColor(currentRow, currentColumn, r, g, b);
    }
    public static void runMosaicSingleCopyColor() {
        Mosaic.open(ROWS, COLUMNS, SQUARE_SIZE, SQUARE_SIZE);
        ...
        currentColumn = COLUMNS / 2;
        while(Mosaic.isOpen()) {
            randomMove2(currentRow, currentColumn);
            Mosaic.delay(100);
        }
    }
