...
${OBJECTDIR}/AnimBase.o: AnimBase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AnimBase.o AnimBase.cpp

${OBJECTDIR}/AnimDirectional.o: AnimDirectional.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AnimDirectional.o AnimDirectional.cpp

${OBJECTDIR}/Game.o: Game.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game.o Game.cpp

${OBJECTDIR}/SpriteSheet.o: SpriteSheet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpriteSheet.o SpriteSheet.cpp

${OBJECTDIR}/Window.o: Window.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Window.o Window.cpp
