...
LDLIBSOPTIONS=-lsfml-system -lsfml-window -lsfml-graphics
...
${OBJECTDIR}/BaseTetromino.o: BaseTetromino.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseTetromino.o BaseTetromino.cpp
...
${OBJECTDIR}/World.o: World.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++17 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/World.o World.cpp
