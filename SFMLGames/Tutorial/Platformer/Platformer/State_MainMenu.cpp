...
State_MainMenu::State_MainMenu(StateManager* l_state) 
    : BaseState{l_state} {
}
...
void State_MainMenu::OnCreate() {
    ...
    for(int i = 0; i < 3; ++i) {
        ...
        m_stateMgr->GetContext()->m_eventManager->AddCallback(StateType::MainMenu, "Mouse_Left", &State_MainMenu::MouseClick, this);
    }
}

void State_MainMenu::OnDestroy() {
    m_stateMgr->GetContext()->m_eventManager->RemoveCallback(StateType::MainMenu, "Mouse_Left");
}

void State_MainMenu::Acitvate() {
