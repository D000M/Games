...
${OBJECTDIR}/test/Dice.o: test/Dice.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/Dice.o test/Dice.cpp

${OBJECTDIR}/utils/RNGGenerator.o: utils/RNGGenerator.cpp
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/RNGGenerator.o utils/RNGGenerator.cpp

${OBJECTDIR}/world/Item.o: world/Item.cpp
	${MKDIR} -p ${OBJECTDIR}/world
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/world/Item.o world/Item.cpp

${OBJECTDIR}/world/ItemsDeck.o: world/ItemsDeck.cpp
	${MKDIR} -p ${OBJECTDIR}/world
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/world/ItemsDeck.o world/ItemsDeck.cpp

${OBJECTDIR}/world/Map.o: world/Map.cpp
	${MKDIR} -p ${OBJECTDIR}/world
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/world/Map.o world/Map.cpp

${OBJECTDIR}/world/Player.o: world/Player.cpp
	${MKDIR} -p ${OBJECTDIR}/world
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/world/Player.o world/Player.cpp

${OBJECTDIR}/world/PlayerDeck.o: world/PlayerDeck.cpp
	${MKDIR} -p ${OBJECTDIR}/world
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/world/PlayerDeck.o world/PlayerDeck.cpp
